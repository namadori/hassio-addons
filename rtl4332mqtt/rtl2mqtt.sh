...
/usr/local/bin/rtl_433  -F json -R 3 -R 24 -R 86 -R 30 -R 48 -f $FREQUENCY -g $GAIN -p $OFFSET \
  -F "mqtt://IP:1883,user=USER,pass=PASS,retain=0,devices=rtl_433[/id]" > /dev/null
